...
<body class="bg-blue-100">
    <div class="bg-yellow-400 flex items-center">
        <div class="pl-4">
            <img src="{{ asset('assets/pictures/logo-logo.png') }}" class="h-14 w-14 object-contain">
        </div>
    ...
    <div class="flex justify-end items-center">
        <img src="{{ asset('assets/pictures/logo-logo.png') }}" style="height: 500px; width: 800px; object-fit: contain;">  
    </div>
